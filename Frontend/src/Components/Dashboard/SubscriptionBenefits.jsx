...
function SubscriptionBenefits() {
  return (
    <div className={styles.Subscriptions}>
      <h4 style={{fontWeight:"bolder"}}>Subscription Benefits</h4>
      ...
      <div className={styles.Subscriptions__Information}>
        <div className={styles.Subscriptions__Information__Left}>
          <h4 style={{fontWeight:"bolder"}}>What is Revv Subscription? </h4>
          <p>
        ...
        <div className={styles.Subscriptions__Information__Right}>
          <iframe 
            width="515" 
            height="266" 
            src="https://www.youtube-nocookie.com/embed/KccvwVosjcU" 
